...
declare global {
	...
	interface Creep {
		travelTo(destination: HasPos | RoomPosition, ops?: TravelToOptions): ScreepsReturnCode;
	}
...
export class Traveler {
	...
	private static serializeState(creep: Creep, destination: RoomPosition, state: TravelState, travelData: TravelData) {
		travelData.state = [
			creep.pos.x, creep.pos.y, state.stuckCount, state.cpu, destination.x, destination.y,
